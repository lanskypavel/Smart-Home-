...
# Project:  backend.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile backend.pro CONFIG+=BUILD_TESTS
#############################################################################
...
DEFINES       = -DBUILD_TESTS -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_SQL_LIB -DQT_TESTLIB_LIB -DQT_CORE_LIB -DQT_TESTCASE_BUILDDIR='"/Users/ilya/smarthouse"'
...
DISTDIR = /Users/ilya/smarthouse/.tmp/SmartHomeServer1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -framework QtGui -framework ImageIO -framework Metal -framework QtNetwork -framework QtSql -framework QtTest -framework Security -framework AppKit -framework ApplicationServices -framework Foundation -framework QtCore -framework IOKit -framework DiskArbitration -framework UniformTypeIdentifiers -framework AGL -framework OpenGL   
...
SOURCES       = clienthandler.cpp \
		main.cpp \
		tcp_server.cpp \
		test_database_singleton.cpp moc_clienthandler.cpp \
		moc_tcp_server.cpp \
		moc_test_database_singleton.cpp
OBJECTS       = clienthandler.o \
		main.o \
		tcp_server.o \
		test_database_singleton.o \
		moc_clienthandler.o \
		moc_tcp_server.o \
		moc_test_database_singleton.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		/opt/homebrew/share/qt/mkspecs/features/testlib_defines.prf \
		...
		clienthandler.h \
		tcp_server.h \
		test_database_singleton.h clienthandler.cpp \
		main.cpp \
		tcp_server.cpp \
...
EXPORT__QMAKE_STASH_ = /Users/ilya/smarthouse/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/ilya/smarthouse/backend.pro
...
Makefile: backend.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		/opt/homebrew/lib/QtTest.framework/Resources/QtTest.prl \
		/opt/homebrew/lib/QtCore.framework/Resources/QtCore.prl
	$(QMAKE) -o Makefile backend.pro CONFIG+=BUILD_TESTS
...
distdir: FORCE
	...
	$(COPY_FILE) --parents DatabaseSingleton.h clienthandler.h tcp_server.h test_database_singleton.h $(DISTDIR)/
	$(COPY_FILE) --parents clienthandler.cpp main.cpp tcp_server.cpp test_database_singleton.cpp $(DISTDIR)/
...
xcodeproj:
	@$(QMAKE) -spec macx-xcode "$(EXPORT__PRO_FILE_)" CONFIG+=BUILD_TESTS
...
moc_test_database_singleton.cpp: test_database_singleton.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/ilya/smarthouse/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/ilya/smarthouse -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/lib/QtSql.framework/Headers -I/opt/homebrew/lib/QtTest.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib test_database_singleton.h -o moc_test_database_singleton.cpp
...
test_database_singleton.o: test_database_singleton.cpp test_database_singleton.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		/opt/homebrew/lib/QtTest.framework/Headers/QtTest \
		/opt/homebrew/lib/QtTest.framework/Headers/qttestglobal.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QVariant \
		/opt/homebrew/lib/QtCore.framework/Headers/qvariant.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o test_database_singleton.o test_database_singleton.cpp
...
moc_test_database_singleton.o: moc_test_database_singleton.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_test_database_singleton.o moc_test_database_singleton.cpp
